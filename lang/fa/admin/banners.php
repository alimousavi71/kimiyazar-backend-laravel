...
return [
    ...
    'forms' => [
        ...
        'placeholders' => [
            ...
            'banner_file' => 'فایل تصویر بنر را انتخاب کنید (هر اندازه‌ای قابل قبول است)',
            'banner_file_update' => 'برای تغییر فایل بنر، فایل جدید را انتخاب کنید (هر اندازه‌ای قابل قبول است)',
            'link' => 'لینک بنر را وارد کنید (اختیاری)',
            'target_type' => 'نوع هدف (اختیاری)',
            'target_id' => 'شناسه هدف (اختیاری)',
        ],
        'messages' => [
            'dimensions_info' => 'تصویر به صورت خودکار به ابعاد :width × :height پیکسل تنظیم می‌شود. می‌توانید تصویر با هر اندازه‌ای آپلود کنید.',
        ],
        'labels' => [
