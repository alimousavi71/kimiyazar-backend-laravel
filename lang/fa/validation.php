...
return [
    ...
    */
    ...
    'after_or_equal' => 'فیلد :attribute باید یک تاریخ بعد از یا برابر :date باشد.',
    ...
    'before_or_equal' => 'فیلد :attribute باید یک تاریخ قبل از یا برابر :date باشد.',
    'between' => [
    ...
    'date_equals' => 'فیلد :attribute باید یک تاریخ برابر :date باشد.',
    ...
    'gte' => [
        ...
        'file' => 'فیلد :attribute باید بیشتر از یا برابر :value کیلوبایت باشد.',
        'numeric' => 'فیلد :attribute باید بیشتر از یا برابر :value باشد.',
        'string' => 'فیلد :attribute باید بیشتر از یا برابر :value کاراکتر باشد.',
    ],
    ...
    'lte' => [
        ...
        'file' => 'فیلد :attribute باید کمتر از یا برابر :value کیلوبایت باشد.',
        'numeric' => 'فیلد :attribute باید کمتر از یا برابر :value باشد.',
        'string' => 'فیلد :attribute باید کمتر از یا برابر :value کاراکتر باشد.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'رمز عبور داده شده در یک نشت داده ظاهر شده است. لطفاً یک :attribute دیگر انتخاب کنید.',
    ],
    ...
    'required_without_all' => 'فیلد :attribute الزامی است وقتی هیچکدام از :values موجود نیست.',
