            ...
            <div class="space-y-6">
                <x-form-group :label="__('admin/products.fields.name')" required :error="$errors->first('name')">
                    <x-input type="text" name="name" id="name"
                        :placeholder="__('admin/products.forms.placeholders.name')"
                ...
                <x-form-group :label="__('admin/products.fields.slug')" :error="$errors->first('slug')">
                    <x-input type="text" name="slug" id="slug"
                        :placeholder="__('admin/products.forms.placeholders.slug')"
                ...
                <x-form-group :label="__('admin/products.fields.category')" :error="$errors->first('category_id')">
                    <x-category-selector name="category_id" id="category_id" :value="old('category_id', $product->category_id)" :categories="$categories"
                        :placeholder="__('admin/products.forms.placeholders.no_category')" class="w-full" />
                </x-form-group>
                ...
                <x-form-group :label="__('admin/products.fields.sale_description')"
                    ...
                    <x-editor name="sale_description" id="sale_description" :value="old('sale_description', $product->sale_description)"
                ...
                <x-form-group :label="__('admin/products.fields.body')" :error="$errors->first('body')">
                    <x-editor name="body" id="body" :value="old('body', $product->body)"
                ...
                <x-form-group :label="__('admin/tags.title')" :error="$errors->first('tags')">
                    <x-tag-manager tagable-type="{{ \App\Models\Product::class }}" :tagable-id="$product->id" />
                </x-form-group>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <x-form-group :label="__('admin/products.fields.is_published')">
                        <x-toggle name="is_published" id="is_published" :checked="old('is_published', $product->is_published)" :label="__('admin/products.forms.labels.published_product')" />
                    </x-form-group>
                </div>
            </div>
        </x-card>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <x-form-group :label="__('admin/products.fields.price_effective_date')"
                        ...
                        <x-input type="date" name="price_effective_date" id="price_effective_date"
                            value="{{ old('price_effective_date', $product->price_effective_date?->format('Y-m-d')) }}"
                            class="w-full" />
                    </x-form-group>
                </div>
            </div>
