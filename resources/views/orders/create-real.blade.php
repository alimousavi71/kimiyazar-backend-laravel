...
<x-layouts.app title="{{ __('orders.forms.create_real.title') }} - {{ $siteTitle }}" dir="rtl">
    <x-web.page-banner :title="__('orders.forms.create_real.title')" />
                        ...
                        <form id="order-form-real" 
                            ...
                            <div class="border-b border-gray-200 pb-6">
                                <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                                    ...
                                    {{ __('orders.forms.national_id_info') }}
                                </h3>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <x-form-group :label="__('orders.fields.national_code')" required :error="$errors->first('national_code')">
                                        <x-input type="text" name="national_code" id="national_code"
                                            :value="old('national_code')" 
                                            placeholder="0000000000" 
                                            maxlength="10"
                                            class="w-full" />
                                        <p class="mt-1 text-xs text-gray-500">{{ __('orders.validation.national_code_size') }}</p>
                                    </x-form-group>
                                    
                                    <x-form-group :label="__('orders.fields.national_card_photo')" required :error="$errors->first('national_card_photo')">
                                        <input type="file" name="national_card_photo" id="national_card_photo"
                            ...
                            <div class="border-b border-gray-200 pb-6">
                                <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                                    ...
                                    {{ __('orders.forms.security_verification') }}
                                </h3>
                                <x-form-group :label="__('orders.forms.captcha_placeholder')" required :error="$errors->first('captcha')">
                                    <div class="flex items-start gap-3">
                                        <div class="flex-1">
                                            <x-input type="text" name="captcha" id="captcha"
                                                :placeholder="__('orders.forms.captcha_placeholder')"
                                        ...
                                        <div class="captcha-wrapper shrink-0">
                                            ...
                                            <button type="button" id="refresh-captcha"
                                                ...
                                                <span>{{ __('orders.forms.new_code') }}</span>
                                            </button>
                                        </div>
                                    </div>
                                    <p class="text-xs text-gray-500 mt-1">{{ __('orders.forms.captcha_help') }}</p>
                                </x-form-group>
                            </div>
    ...
    @push('scripts')
        @vite(['resources/js/captcha-refresh.js'])
    @endpush
</x-layouts.app>
