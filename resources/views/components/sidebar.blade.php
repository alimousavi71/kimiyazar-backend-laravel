        ...
        <ul class="space-y-1.5">
            ...
            <li>
                <a href="{{ route('admin.price-inquiries.index') ?? '#' }}"
                    ...
                    @if(request()->routeIs('admin.price-inquiries.*'))
                        <div
                            class="absolute start-0 top-0 bottom-0 w-1.5 bg-gradient-to-b from-green-500 via-emerald-500 to-green-600 rounded-e-full shadow-lg shadow-green-500/50">
                        </div>
                    @endif
                    <div
                        class="relative z-10 p-1.5 rounded-lg {{ request()->routeIs('admin.price-inquiries.*') ? 'bg-green-100/50' : 'bg-gray-100/50 group-hover:bg-green-100/50' }} transition-all duration-300">
                        <x-icon name="dollar" size="md"
                            class="transition-all duration-300 {{ request()->routeIs('admin.price-inquiries.*') ? 'text-green-600 scale-110' : 'text-gray-500 group-hover:text-green-600 group-hover:scale-110' }}" />
                    </div>
                    <span class="relative z-10 flex-1">{{ __('admin/components.navigation.price_inquiries') }}</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('admin.menus.index') ?? '#' }}"
                    ...
                    @endif
                    <div
                        class="relative z-10 p-1.5 rounded-lg {{ request()->routeIs('admin.menus.*') ? 'bg-green-100/50' : 'bg-gray-100/50 group-hover:bg-green-100/50' }} transition-all duration-300">
                        <x-icon name="menu" size="md"
                            class="transition-all duration-300 {{ request()->routeIs('admin.menus.*') ? 'text-green-600 scale-110' : 'text-gray-500 group-hover:text-green-600 group-hover:scale-110' }}" />
                    </div>
                    <span class="relative z-10 flex-1">{{ __('admin/components.navigation.menus') }}</span>
                </a>
            </li>
