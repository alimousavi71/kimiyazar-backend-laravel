...
@php
    $variants = [
        'primary' => 'bg-gradient-to-r from-green-500 to-emerald-400 text-white hover:from-green-600 hover:to-emerald-500 focus:ring-2 focus:ring-green-500 focus:ring-offset-2',
        ...
        'outline' => 'border-2 border-green-500 text-green-600 hover:bg-green-50 focus:ring-2 focus:ring-green-500 focus:ring-offset-2',
    ];
