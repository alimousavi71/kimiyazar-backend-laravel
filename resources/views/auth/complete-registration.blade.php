...
<x-layouts.auth :title="$title">
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden w-full max-w-md" x-data="passwordForm()">
        <!-- Header -->
        <div class="bg-gradient-to-br from-purple-600 to-indigo-600 px-6 py-8 text-center">
            ...
            <p class="text-purple-100 text-sm">{{ __('auth.complete_registration.subtitle') }}</p>
        </div>
